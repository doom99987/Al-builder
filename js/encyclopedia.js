...
(function () {
  ...
  const ENC_ITEMS = [
    ...
    ['Arbusta Tear',          'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Thief">Thief</button>, <button class="enc-desc-link" data-enc-nav="Slime">Slime</button>, <button class="enc-desc-link" data-enc-nav="Grass Spirit">Grass Spirit</button>, and <button class="enc-desc-link" data-enc-nav="Zombie Mushroom">Zombie Mushroom</button>.'],
    ['Aspect of Maladaptation','Gear',           'Drops from <button class="enc-desc-link" data-enc-nav="Thorian, The Rotten">Thorian</button>.'],
    ['Band Of Crushing Force', 'Gear',           'Drops from <button class="enc-desc-link" data-enc-nav="Sand Golem">Sand Golem</button>.\n\nA band that amplifies the raw force behind physical strikes.'],
    ['Blazing Perforator',    'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Yar\'Thul, The Blazing Dragon">Yar\'Thul</button>.'],
    ['Chocolate Egg',         'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Gigapascha">Gigapascha</button>. Can also be obtained from an <button class="enc-desc-link" data-enc-nav="Egg Basket">Egg Basket</button>.\n\nA festive egg of mysterious origin. A rare seasonal collectible.'],
    ['Coagulated Finger Nail','Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Cursed Corpse">Cursed Corpse</button>.'],
    ['Crystal Sphere',        'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Sand Elemental">Sand Elemental</button>.'],
    ...
    ['Cursed Brand',          'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Cursed Corpse">Cursed Corpse</button> and <button class="enc-desc-link" data-enc-nav="Sentient Darkness">Sentient Darkness</button>.\n\nA brand marked with a curse. Grants power at the cost of the wearer\'s stability.'],
    ...
    ['Desert Escutcheon',     'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Duneguard">Duneguard</button>.'],
    ['Divine Promise',        'Gear',            ''],
    ['Dragon Memior',         'Gear',            ''],
    ...
    ['Frosty Topper',         'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Frosted Slime">Frosted Slime</button> and <button class="enc-desc-link" data-enc-nav="Joyous Spirit">Joyous Spirit</button>.'],
    ['Gelat Band',            'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Slime King">Slime King</button>.'],
    ['Gilded Pouch',          'Gear',            ''],
    ...
    ['Magma Charm',           'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Lava Crab">Lava Crab</button>.'],
    ['Molten Carapace',       'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Lava Crab">Lava Crab</button>.'],
    ["Narthana's Leaf",       'Gear',            ''],
    ['Open Hand',             'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Handaconda">Handaconda</button>.'],
    ['Parasitic Leech',       'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Goblin">Goblin</button>.'],
    ['Party Egg',             'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Gigapascha">Gigapascha</button>.\n\nActive — Egg Throw (Cost: 2, CD: 6): Throws an egg dealing 5 damage (SPD/80 scaling). On hit grants 7.5% speed boost and applies 2 random status effects.'],
    ...
    ['Snorb',                 'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Frosted Slime">Frosted Slime</button> and <button class="enc-desc-link" data-enc-nav="Joyous Spirit">Joyous Spirit</button>.'],
    ['Spiked Steel Ball',     'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Desert Bandit">Desert Bandit</button>.\n\nPassive: 30–40% chance to apply 1 Vulnerable and 1 Weakened on hit. Deals an additional 35% damage when this effect procs.'],
    ['Spore Root',            'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Zombie Mushroom">Zombie Mushroom</button>.'],
    ['Stone Brand',           'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Sand Golem">Sand Golem</button>.'],
    ['Tainted Quiver',        'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Thorian, The Rotten">Thorian</button>.'],
    ['Tear Blood Crystal',    'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Carnis">Carnis</button>.'],
    ['The Biggest Pebble',    'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Thief">Thief</button> and <button class="enc-desc-link" data-enc-nav="Slime">Slime</button>.\n\nAn impressive specimen of a pebble. Completely unremarkable, yet somehow sought after.'],
    ['The Last Straw',        'Gear',            ''],
    ['The Smallest Boulder',  'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Handaconda">Handaconda</button>.'],
    ["Traveler's Lamp",       'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Cursed Corpse">Cursed Corpse</button>.'],
    ['Vainglorious Locket',   'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Metrom\'s Vessel">Metrom\'s Vessel</button>.'],
    ['Vow of Ruin',           'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Arkhaia">Arkhaia</button>.'],
    ...
    ['Vulcan Knuckle',        'Gear',            'Drops from <button class="enc-desc-link" data-enc-nav="Magma Golem">Magma Golem</button>.'],
    ...
    ['Adept Warrior',          'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Blade Dancer (N)">Blade Dancer</button>\n\nRequirements: Level 20, 750g, 2 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +15 Endurance, +10% Max HP, +5% Strength, +16.6% Energy, +20% Fall Resistance.\n\nDamage Reduction: +5% Physical, +10% Dark.'],
    ['Raging Warrior',         'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Berserker (Ch)">Berserker</button>\n\nRequirements: Level 20, 750g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 3 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +16 Endurance, +10% Max HP, +10% Increased Healing, +10% Energy.\n\nDamage Reduction: +5% Physical, +10% Hex, +5% Fire.'],
    ['Arcane Robes',           'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Elementalist (Or)">Elementalist</button>\n\nRequirements: Level 20, 750g, 2 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>.\n\nStats: +15 Endurance, +4 Arcane, +7.5% Arcane.\n\nDamage Reduction: +10% Magic, +10% Poison, +10% Holy, +10% Fire.'],
    ['Magister Apprentice',    'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Hexer (N)">Hexer</button>\n\nRequirements: Level 20, 750g, 3 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +15 Endurance, +3 Arcane, +5% Arcane, +1 HP Regen/turn.\n\nDamage Reduction: +15% Magic, +10% Poison, +10% Fire.'],
    ['Corrupt Caster',         'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Necromancer (Ch)">Necromancer</button>\n\nRequirements: Level 20, 750g, 3 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +16 Endurance, +5% Max HP, +2 Arcane, +5% Arcane, +10% Energy.\n\nDamage Reduction: +15% Magic, +10% Poison, +10% Holy.'],
    ['Lifebound Archer',       'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Ranger (Or)">Ranger</button>\n\nRequirements: Level 20, 750g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +15 Endurance, +5% Max HP, +3 Arcane, +5% Arcane, +1 HP Regen/turn, +15% Movement Speed.\n\nDamage Reduction: +10% Magic, +10% Poison, +10% Nature.'],
    ['Rogue Hunter',           'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Rogue (N)">Rogue</button>\n\nRequirements: Level 20, 750g, 2 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +15 Endurance, +7.5% Max HP, +10% Speed, +10% Energy, +1 HP Regen/turn, +20% Movement Speed, +25% Fall Resistance.\n\nDamage Reduction: +5% Physical, +5% Fire.'],
    ['Shadow Cloak',           'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Assassin (Ch)">Assassin</button>\n\nRequirements: Level 20, 750g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +13 Endurance, +7.5% Max HP, +12.5% Energy, +1 HP Regen/turn, +30% Movement Speed, +30% Fall Resistance.\n\nDamage Reduction: +5% Physical, +5% Dark.'],
    ['Traveling Pasmark',      'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Monk (Or)">Monk</button>\n\nRequirements: Level 20, 750g, 2 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +5 Strength, +16 Endurance, +7.5% Max HP, +5% Strength, +1 HP Regen/turn, +10% Fall Resistance.\n\nDamage Reduction: +5% Physical, +5% Holy, +5% Fire, +5% Dark.'],
    ['Wandering Practitioner', 'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Brawler (N)">Brawler</button>\n\nRequirements: Level 20, 750g, 2 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +18 Endurance, +7.5% Max HP, +10% Strength, +16.6% Energy, +10% Fall Resistance.\n\nDamage Reduction: +5% Physical, +10% Fire.'],
    ['Shade Walker',           'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Darkwraith (Ch)">Darkwraith</button>\n\nRequirements: Level 20, 750g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 3 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +18 Endurance, +7.5% Max HP, +5% Arcane, +10% Fall Resistance.\n\nDamage Reduction: +5% Physical, +10% Hex, +20% Dark.'],
    ['Pathfinder Martyr',      'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Saint (Or)">Saint</button>\n\nRequirements: Level 20, 750g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +3 Arcane, +1 Speed, +20 Endurance, +7.5% Max HP, +1 HP Regen/turn.\n\nDamage Reduction: +5% Physical, +15% Holy.'],
    ['Armored Lancer',         'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Lancer (N)">Lancer</button>\n\nRequirements: Level 20, 750g, 3 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +20 Endurance, +15% Max HP, +12.5% Energy.\n\nDamage Reduction: +10% Physical, +10% Magic, +5% Fire.\n\nPenalty: -5% Movement Speed.'],
    ['Bloody Menace',          'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Impaler (Ch)">Impaler</button>\n\nRequirements: Level 20, 750g, 2 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +22 Endurance, +10% Max HP, +20% Increased Healing.\n\nDamage Reduction: +10% Physical, +5% Hex, +5% Poison.'],
    ['Venerated Legionnaire',  'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Lionheart (N)">Lionheart</button>\n\nRequirements: Level 20, 750g, 8 <button class="enc-desc-link" data-enc-nav="Mushroom Cap">Mushroom Cap</button>, 12 <button class="enc-desc-link" data-enc-nav="Slime Chunk">Slime Chunk</button>, 1 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>, 2 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>.\n\nStats: +17 Endurance, +12.5% Max HP.\n\nDamage Reduction: +15% Physical, +15% Fire, +10% Ice, +10% Nature, +5% Dark, +5% Magic.'],
    ['Fortified Seer',         'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Citadel (Or)">Citadel</button>\n\nRequirements: Level 20, 750g, 8 <button class="enc-desc-link" data-enc-nav="Sand Core">Sand Core</button>, 3 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +35 Endurance, +5% Max HP.\n\nDamage Reduction: +15% Dark, +15% Hex, +10% Holy, +10% Ice, +10% Fire, +10% Physical.'],
    ['Deathmantle',            'Armour', 'Superclass: <button class="enc-desc-link" data-enc-nav="Arbiter (N)">Arbiter</button>\n\nRequirements: Level 20, 750g, 5 <button class="enc-desc-link" data-enc-nav="Rot Core">Rot Core</button>, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 3 <button class="enc-desc-link" data-enc-nav="Laneus Ore">Laneus Ore</button>.\n\nStats: +25 Endurance, +2.5% Max HP, +10% Arcane.\n\nDamage Reduction: +20% Dark, +15% Holy, +10% Magic, +10% Ice, +5% Physical.'],
    ['Budding Mage',            'Armour', 'Requirements: Level 5, 80g.\n\nStats: +5 Endurance, +1 Arcane.\n\nDamage Reduction: +10% Magic, +10% Poison.'],
    ['Chainmail Guard',         'Armour', 'Requirements: Level 8, 140g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>, 1 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +15 Endurance, +10% Max HP.\n\nDamage Reduction: +10% Physical.\n\nPenalty: -15% Movement Speed, -15% Magic.'],
    ['Explorer',               'Armour', 'Requirements: Level 5, 90g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>.\n\nStats: +12 Endurance, +15% Movement Speed, +10% Fall Resistance.\n\nDamage Reduction: +10% Physical.'],
    ['Nobleman',               'Armour', 'Requirements: Level 10, 150g, 1 <button class="enc-desc-link" data-enc-nav="Aestic Ore">Aestic Ore</button>.\n\nStats: +10 Endurance, +5% Movement Speed.\n\nDamage Reduction: +10% Physical, +5% Magic.'],
    ['Shadowy Crook',          'Armour', 'Requirements: Level 7, 100g.\n\nStats: +10 Endurance, +10% Movement Speed, +1 Speed, +2 Luck.\n\nDamage Reduction: +5% Physical.'],
    ['Trapper',                'Armour', 'Requirements: Level 10, 140g, 1 <button class="enc-desc-link" data-enc-nav="Ferrus Ore">Ferrus Ore</button>.\n\nStats: +18 Endurance, +5% Movement Speed, +2 Strength.\n\nDamage Reduction: +10% Physical.'],
    ['Wandering Scoundrel',    'Armour', 'Requirements: Level 5, 125g.\n\nStats: +15 Endurance, +25% Movement Speed, +10% Fall Resistance.\n\nDamage Reduction: +5% Physical.'],
    ['Wayfarer',               'Armour', 'Requirements: Level 10, 145g.\n\nStats: +15 Endurance, +15% Movement Speed, +15% Fall Resistance.\n\nDamage Reduction: +15% Physical.'],
  ...
  function render() {
    ...
    TYPE_ORDER.forEach(type => {
      ...
      if (type === 'Weapon') {
        ...
        const groupedNames = new Set(ARMOUR_GROUPS.flatMap(g => [...g.names]));
        const ungrouped = items.filter(({ it }) => !groupedNames.has(it[0]));
        if (ungrouped.length) {
          const grid = document.createElement('div');
          grid.className = 'enc-grid';
        ...
        const byGroup = {};
        ARMOUR_GROUPS.forEach(g => { byGroup[g.label] = []; });
        items.forEach(({ it, i }) => {
          ARMOUR_GROUPS.forEach(g => { if (g.names?.has(it[0])) byGroup[g.label].push({ it, i }); });
        });
        ARMOUR_GROUPS.forEach(g => {
          const gItems = byGroup[g.label];
          if (!gItems.length) return;
          const groupDiv = document.createElement('div');
          groupDiv.className = 'enc-weapon-group';
